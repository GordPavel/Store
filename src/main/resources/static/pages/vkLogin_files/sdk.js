/*1542655447,,JIT Construction: v4549120,ru_RU*/
...
try {
		...
		(function () {
			...
			with (this) {
				...
				__d("JSSDKRuntimeConfig", [], {
					...
					"sdkab": null,
					"sdkns": "FB",
					"sdkurl": "https:\/\/connect.facebook.net\/ru_RU\/sdk.js"
				});
				__d("JSSDKConfig", [], {
					"features": {
				...
				__d("JSSDKXDConfig", [], {
					...
					"XdBundleUrl": "\/connect\/xd_arbiter\/r\/afATJJjxKE6.js?version=43",
				...
				__d("Env", [], (function (a, b, c, d, e, f) {
					b = {start: ES("Date", "now", !1), nocatch: !1, ajaxpipe_token: null};
				...
				__d("invariant", ["Env", "TAAL", "ex", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j) {
					...
					function a(a, b) {
						...
						if (!a) {
							...
							if (typeof c === "number") {
								var g = l(c, e), i = g.message, j = g.decoderLink;
								c = i;
								e.unshift(j)
							} else if (c === undefined) {
								c = "Invariant: ";
				...
				__d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h) {
					...
					function k(a) {
						...
						if (a === null || a === undefined) return null; else return a[1]
					}

					a = {
						setDomain: function (a) {
							i = a;
							a = g.encode({base_domain: i !== null && i !== "." ? i : ""});
							var b = new Date();
				...
				__d("XDM", ["DOMWrapper", "Log", "UserAgent_DEPRECATED", "emptyFunction", "guid", "sdk.DOMEventListener", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
					__p && __p();
					var n = {}, o = {transports: []}, p = g.getWindow();

					function q(a) {
						__p && __p();
						var b = {}, c = a.length, d = o.transports;
						while (c--) b[a[c]] = 1;
						c = d.length;
						while (c--) {
							a = d[c];
							...
							isAvailable: function () {
								...
								var c = "_FB_" + b.channel, d = {
									send: function (a, b, c, d) {
										...
										i.ie() == 8 || i.ieCompatibilityMode() ? setTimeout(e, 0) : e()
									}
								};
								if (a) {
									b.whenReady(d);
								...
								l.add(p, "message", m(function (event) {
									__p && __p();
									var a = event.data, d = event.origin || "native";
									if (!/^(https?:\/\/|native$)/.test(d)) {
										h.debug("Received message from invalid origin type: %s", d);
										return
									}
									if (d !== "native" && !(r.test(location.hostname) || r.test(event.origin))) return;
									if (typeof a !== "string") {
										h.warn("Received message of type %s from %s, expected a string", typeof a, d);
										return
									}
				...
				__d("sdk.createIframe", ["getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike", "sdk.DOMEventListener"], (function (a, b, c, d, e, f, g, h, i, j, k) {
					...
					function a(a) {
						...
						var b, c = a.name || h(), d = a.root, e = a.style || {border: "none"}, f = a.url, l = a.onload,
							m = a.onerror;
				...
				__d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
					__p && __p();
					var w = new j(), x = new j(), y = m(), z = "https";
					a = g.useCdn ? "cdn" : "www";
					...
					var B = m(), C = c(), D, E, F = !1, G = "Facebook Cross Domain Communication Frame", H = {},
						I = new j();
					s.setInQueue(I);
					...
					function N(a) {
						...
						var b = o.appendHidden(document.createElement("div")), c = l.create({
							blacklist: null, root: b, channel: B, whenReady: function (d) {
								D = d;
				...
				__d("sdk.Auth", ["DOMWrapper", "Log", "OAuthControllerParameterName", "ObservableMixin", "UrlMap", "guid", "sdk.Cookie", "sdk.createIframe", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.WebStorage", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
					__p && __p();
					var x = "fblst_", y = "fblo_", z = 365 * 24 * 60 * 60 * 1e3, A, B, C = new j();
					...
					function D(a, b) {
						...
						e = r.getLoginStatus();
						var f = e === "unknown" && a || r.getUseCookie() && r.getCookieUserID() !== d, g = c && !a;
						c = a && c && c != d;
						var h = a != A;
						e = b != (e || "unknown");
						r.setLoginStatus(b);
					...
					function F(a, b, c) {
						...
						return function (d) {
							...
							if (d && d.access_token) {
								...
								d.granted_scopes && (b = babelHelpers["extends"]({}, b, {grantedScopes: d.granted_scopes}));
								d.reauthorize_required_in && (b = babelHelpers["extends"]({}, b, {reauthorize_required_in: parseInt(d.reauthorize_required_in, 10)}));
								d.data_access_expiration_time && (b = babelHelpers["extends"]({}, b, {data_access_expiration_time: Number(d.data_access_expiration_time)}));
								d.enforce_https && (e = !0);
								if (r.getUseLocalStorage() && location.protocol === "https:" && d.long_lived_token) {
									f = v.getLocalStorage();
								...
								g = "connected";
								D(b, g)
							} else (c === "logout" || c === "login_status") && (d && d.error && d.error === "not_authorized" ? (g = "not_authorized", D(null, g)) : d && d.error && d.error === "authorization_expired" ? (g = "authorization_expired", D(null, g)) : (g = "unknown", D(null, g)), r.getUseCookie() && m.clearSignedRequestCookie(), r.getUseLocalStorage() && G(), c === "logout" && (I(), s.log("jssdk_error", {
								appId: r.getClientID(),
					...
					function J(a) {
						...
						d = new u(k.resolve("www") + "/connect/ping").addQueryData(i.CLIENT_ID, r.getClientID()).addQueryData(i.RESPONSE_TYPE, "token,signed_request").addQueryData(i.DOMAIN, location.hostname).addQueryData(i.ORIGIN, p()).addQueryData(i.REDIRECT_URI, w.handler(function (a) {
							...
							e(a) && (B = window.setTimeout(function () {
								J(function () {
								})
							}, 12e5))
						}, "parent")).addQueryData(i.SDK, "joey").addQueryData(i.VERSION, r.getIsVersioned() ? r.getVersion() : null);
						...
						b = n({root: g.getRoot(), name: l(), url: d.toString(), style: {display: "none"}})
					}
					...
					function a(a, b) {
						...
						K = "loading";
						c = function (a) {
							K = "loaded", C.inform("FB.loginStatus", a), C.clearSubscribers("FB.loginStatus")
						};
						J(c)
					}
				...
				__d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
					...
					function t(a, b, c, d) {
						...
						return p.guard(function () {
							...
							var f = ES(Array.prototype.slice.call(arguments), "map", !0, e), g = a.apply(d, f), h,
								i = !0;
				...
				__d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
					__p && __p();
					var r, s, t, u = l.MAX_QUERYSTRING_LENGTH, v = {
						fql_query: !0,
						fql_multiquery: !0,
						friends_get: !0,
						notifications_get: !0,
					...
					var F = ES("Object", "assign", !1, new n(), {
						setAccessToken: function (a) {
							...
							return y.length
						}, rest: b, graph: E, scheduleBatchCall: a, prepareBatchParams: g.prepareBatchParams
					});
				...
				__d("sdk.unsecureDisallowed", ["Log", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j) {
					"use strict";
					__p && __p();
					var k = h("https_only_enforce_starting", !1), l = h("https_only_learn_more", ""), m = {};
				...
				__d("sdk.api", ["ApiClient", "sdk.feature", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.unsecureDisallowed"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
					__p && __p();
					var n = h("should_log_response_error", !1), o;
				...
				__d("sdk.Dialog", ["ObservableMixin", "Type", "sdk.Canvas.Environment", "sdk.Content", "sdk.DialogUtils", "sdk.DOM", "sdk.DOMEventListener", "sdk.fbt", "sdk.Runtime", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
					...
					var w = h.extend({
						...
						_createMobileLoader: function () {
							var a;
							p.nativeApp() ? a = '<div class="dialog_header"></div>' : x.isTabletStyle() ? a = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + n._("\u041e\u0442\u043c\u0435\u043d\u0430") + "</a></div>" : a = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + n._("\u041e\u0442\u043c\u0435\u043d\u0430") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + n._("\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
				...
				__d("sdk.Extensions", ["JSONRPC", "Queue", "sdk.NativeExtensions", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j) {
					...
					j.facebookInAppBrowser() && i.onReady(function (a) {
						...
						}, a.initializeCallbackHandler(ES("JSON", "stringify", !1, {name: "_FBBrowserCallbackHandler"})), k.start(function (b) {
							a.jsonRPC(b)
						})
					});
					e.exports = {
				...
				__d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E) {
					...
					a = {
						...
						"permissions.oauth": {
							url: "dialog/oauth",
							size: {width: D.mobile() ? null : 600, height: D.mobile() ? null : 679},
							transform: function (a) {
								__p && __p();
								if (!B.getClientID()) {
								...
								if (o.getAuthResponse() && !a.params.scope && !a.params.auth_type) {
									...
									a.cb && a.cb({status: B.getLoginStatus(), authResponse: o.getAuthResponse()});
									return
								}
								var b = a.cb, c = a.id;
								delete a.cb;
						...
						"auth.logout": {
							url: "logout.php", transform: function (a) {
								if (!B.getClientID()) g.error("FB.logout() called before calling FB.init()."); else if (!o.getAuthResponse()) g.error("FB.logout() called without an access token."); else {
					...
					var M = {
						...
						prepareCall: function (a, b) {
							...
							ES("Object", "assign", !1, a, {
								...
								locale: B.getLocale(),
								sdk: "joey",
								access_token: f && B.getAccessToken() || undefined
							});
							...
							(b === "parent" || b === "opener") && ES("Object", "assign", !1, f.params, {channel_url: M._xdChannelHandler(e, b === "parent" ? "parent.parent" : "opener")}, !0);
							f = M.prepareParams(f);
							return f
						},
						...
						popup: function (a) {
							__p && __p();
							var b = window.screenX, c = window.screenY, d = window.outerWidth, e = window.outerHeight,
								f = D.mobile() ? null : a.size.width, g = D.mobile() ? null : a.size.height;
						...
						_insertIframe: function (a) {
							...
							a.post ? m({
								...
								onInsert: b,
								onload: function (b) {
									p.submitToTarget({url: a.url, target: b.name, params: a.params})
								}
							}) : m({
								url: a.url,
								root: a.root,
						...
						_xdChannelHandler: function (a, b) {
							...
							return E.handler(function (b) {
								...
								if (!c) return;
								if (b.type == "resize") M._handleResizeMessage(a, b); else if (b.type == "hide") q.hide(c); else if (b.type == "rendered") {
									c = q._findRoot(c);
									q.show(c)
				...
				__d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui", "sdk.unsecureDisallowed"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
					...
					g.provide("", {
						...
						if (l.getClientID()) if (a.authResponse) i.setAuthResponse(a.authResponse, "connected"); else if (l.getUseCookie()) {
				...
				__d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.fbt", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
					...
					var m = function () {
						...
						function a(a) {
							...
							var b = a.parentNode;
							if (!b) return;
							var c = h.getAttr(a, "href") || window.location.href, d = new l(g.resolve("m"));
				...
				__d("legacy:fb.init", ["FB", "sdk.Event", "sdk.init"], (function (a, b, c, d, e, f, g, h, i) {
					"use strict";
					g.provide("", {init: i}), h.subscribe("init:post", function () {
				...
				__d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
					"use strict";
					__p && __p();
					var k = window.performance, l = k && "now" in k && "getEntriesByName" in k, m, n = {};
					if (l) {
						var o = j.getSDKUrl();
						a = null;
						...
						if (b.length > 1) b = null; else if (b.length === 1) {
						...
						b && (n.fetchTime = Math.round(b.duration), a && (n.fetchTime += Math.round(a.duration)), "transferSize" in b && (n.transferSize = b.transferSize, a && (n.transferSize += a.transferSize)), g.debug("sdkperf: it took %s ms and %s bytes to load %s", n.fetchTime, n.transferSize, o), m = b.startTime, n.ns = j.getSDKNS(), m && window.setTimeout(function () {
							var a = h("log_perf", !1), b = j.getSDKAB();
							b && (n.ab = b, a = !0);
							a && i.log(116, n)
						}, 1e4))
					}
				...
				__d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "resolveURI", "sdk.Auth", "sdk.createIframe", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
					...
					var E = j.extend({
						constructor: function (a, b, c, d) {
							...
							var f = k.resolve("www") + "/plugins/" + c + ".php?", g = {};
				...
				__d("sdk.XFBML.Comments", ["IframePlugin", "QueryString", "UrlMap", "sdk.DOM", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
					__p && __p();
					var o = 320, p = ES("Object", "assign", !1, {
						numposts: "string",
						href: "url",
						permalink: "bool",
						order_by: "string",
				...
				__d("sdk.XFBML.CommentsCount", ["ApiClient", "ObservableMixin", "sdk.DOM", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j) {
					__p && __p();
					var k;
					...
					function a(a, b, c, d) {
						"use strict";
						k.constructor.call(this), this.__observableEvents = {}, this.dom = a, this.href = d.href || window.location.href
					}

					a.prototype.process = function () {
						"use strict";
						i.addCss(this.dom, "fb_comments_count_zero"), g.scheduleBatchCall("/v2.1/" + encodeURIComponent(this.href), {fields: "share"}, ES(function (a) {
							a = a.share && a.share.comment_count || 0;
							i.html(this.dom, j('<span class="fb_comments_count">%s</span>', a));
				...
				__d("sdk.XFBML.CustomerChat", ["IframePlugin", "Log", "QueryString", "getDocumentScrollElement", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
					...
					var v = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
						w = null, x = !(t.ie() <= 9), y = null, z = !1, A = null, B = "", C = !1, D = 0, E = 0, F = !1,
						G = null;
					a = g.extend({
						constructor: function (a, b, c, d) {
							...
							this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
								...
								width: "288pt",
								zIndex: "2147483647"
							}), o.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || x ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) && (z = !0, ES("Object", "assign", !1, this._iframe.style, {height: "378pt"})), A = this._iframe)
							...
							if (this._iframe) {
								...
								if (b) z = !0, ES("Object", "assign", !1, this._iframe.style, {
									...
									top: "0",
									width: "100%"
								}), ES("JSON", "parse", !1, a.dialogHidden) || H(); else if (C) if (!ES("JSON", "parse", !1, a.showInterstitialOnPage)) {
									b = screen.width - 120;
									ES("Object", "assign", !1, this._iframe.style, {
										bottom: "12px",
										right: "84px",
								...
								} else this._makeDialogIframeFullScreen(), F = !0; else ES("Object", "assign", !1, this._iframe.style, {
									borderRadius: "9pt",
									bottom: "63pt",
									right: "3pt",
									top: "auto",
					...
					function H() {
						D = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, E = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, o.addCss(document.body, "fb_mobile_overlay_active")
					}
					...
					function J(a, b, c, d) {
						...
						if (G === null || G === !1) {
							...
							u.sendToFacebook(B, {
								...
								params: ES("JSON", "stringify", !1, {is_dialog_hidden: !1})
							});
							G = !0
						}
					...
					function K(a, b, c, d) {
						...
						if (G === null || G === !0) {
							c && (b || C && F) && I();
							if (!x) o.setStyle(e, "maxHeight", "0"); else {
								var f = function a(d) {
									var f;
									c && (b || C && F) ? f = "fb_bounce_out_v2_mobile_chat_started" : f = "fb_bounce_out_v2";
									d.animationName === f && (o.setStyle(e, "maxHeight", "0"), ES(v, "forEach", !0, function (event) {
										p.remove(e, event, a)
									}))
								}, g;
							...
							u.sendToFacebook(B, {
								method: "CustomerChat.isDialogHidden",
								params: ES("JSON", "stringify", !1, {is_dialog_hidden: !0})
							});
							G = !1
						}
				...
				__d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "safeEval", "sdk.ErrorHandling", "sdk.feature", "sdk.Runtime", "sdk.Scribe", "sdk.ui", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
					__p && __p();
					var p = k("https_only_enforce_starting", !1), q = k("https_only_learn_more", "");
					...
					a = g.extend({
						constructor: function (a, b, c, d) {
							...
							this.parent(a, b, c, d);
							var f = g.getVal(d, "on_login"), i = null, j = this._iframeOptions.name;
							f && (i = function (a) {
								if (a.error_code) {
	...
	new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4549120","namespace":"FB","message":"' + e.message + '"}}');
}